                ...
                <div style="padding: 0px;">
                    <div class="header-container">
                        <div style="padding: 0px;">
                            ...
                            <span role="img" aria-label="left" class="anticon anticon-left"
                                  style="font-size: 25px; color: rgb(255, 255, 255);"><svg
                        ...
                        <span class="ant-typography"
                              style="font-weight: 700; font-size: 20px; color: rgb(255, 255, 255);"><strong>Thông báo</strong></span>
                        <div></div>
                    </div>
                    <div style="padding: 5px;">
                        <div class="ant-empty">
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        <g transform="translate(24 31.67)">
                                            <ellipse cx="67.797" cy="106.89" rx="67.797" ry="12.668"
                                                     class="ant-empty-img-default-ellipse"></ellipse>
                                            <path
                            ...
                            <div class="ant-empty-description">Chưa có thông báo nào.</div>
                        </div>
                    </div>
                </div>
            </div> <!----> <!----></div>
