            ...
            <div class="fadein" style="height: calc(100vh - 80px); background-color: rgb(245, 245, 245);">
                <div style="padding: 10px 15px; opacity: 1; transform: none;">
                    <div
                        ...
                        <span class="ant-typography" style="font-weight: 700; font-size: 20px;"><strong>Thông tin tài khoản thanh toán</strong></span>
                        <div></div>
                    </div>
                    <div style="">
                        <div class="bank-container">
                            <div role="separator"
                                ...
                                <span class="ant-divider-inner-text"><span class="ant-typography"
                                                                           style="font-size: 16px;">Tài khoản ngân hàng</span></span>
                            </div>
                            <div>
