<div style="position: fixed; z-index: 1000; bottom: 0px; min-width: 100%;">
    <div
        ...
        <div
            ...
            <a href="/vi-tien" style="display: grid">
        ...
        <div
            style="min-height: 45px; display: flex; justify-content: center; align-items: center; flex-direction: column; background: rgb(255, 255, 255);">
            @if (Auth::check())
                <a href="{{$linkCSKH}}" style="display: grid">
                    <i aria-label="icon: customer-service" class="anticon anticon-customer-service"
                       style="font-size: 20px;">
                        <svg viewBox="64 64 896 896" style="fill: #666" data-icon="customer-service" width="1em"
                             height="1em"
                    ...
                    </i> <span class="ant-typography" style="font-size: 12px;">CSKH</span>
                </a>
            @else
                <a href="{{$linkCSKH}}" style="display: grid">
                    <i aria-label="icon: customer-service" class="anticon anticon-customer-service"
        ...
        <div
            style="min-height: 45px; display: flex; justify-content: center; align-items: center; flex-direction: column; background: rgb(255, 255, 255);">
            <a href="{{route('user.hoSo')}}" style="display: grid"><span role="img" aria-label="user"
                                                                         class="anticon anticon-user"
                                                                         style="font-size: 20px; color: rgb(102, 102, 102);"><svg
