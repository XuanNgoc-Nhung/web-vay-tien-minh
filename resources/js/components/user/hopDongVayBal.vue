            ...
            <div>
                <div class="ant-modal-body">
                    <div>
                        ...
                        <p>Địa chỉ :&nbsp;số 3 Liễu Giai, Phường Liễu Giai, Quận Ba Đình, Thành phố Hà Nội, Việt Nam</p>
                        <p>Mã số doanh nghiệp : 2001377411</p>
                        <p>Người đại diện pháp luật : ÔNG (BÀ) HÀ ANH DŨNG</p>
                        ...
                        <p>1.3 TIỀN LÃI &nbsp;<span id="interestRateSetting"
                                                    style="color:red">{{
                                (parseInt(thongTinCaNhan.lai_suat / 100).toFixed(2))
                            }}%</span></p>
                    ...
                    <div><br>
                        <p>Người vay ký</p> <img id="contractAppend" :src="thongTinCaNhan.chu_ky" width="250px"> <h5
                            id="contractAppendName">{{ thongTinCaNhan.ho_ten }}</h5></div>
                </div>
            </div>
